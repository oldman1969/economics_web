  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-10">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">公司的本质</h1>
        <p className="text-gray-500">第二层 · 认识公司 —— 股票 = 公司所有权凭证</p>
      </div>

      <div className="space-y-4">
        {COMPANY_ARTICLES.map((a, i) => (
          <Link key={a.id} to={`/investing/company-essence/${a.id}`} className="card card-hover no-underline group block">
