...
export const RESOURCE_CATEGORIES: ResourceCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: '聪明的投资者', author: '本杰明·格雷厄姆', desc: '价值投资奠基之作，新手入门首选', tag: '经典' },
      { name: '证券分析', author: '本杰明·格雷厄姆', desc: '被誉为"投资者的圣经"', tag: '经典' },
      { name: '巴菲特致股东的信', author: '沃伦·巴菲特', desc: '巴菲特投资理念的精髓，每年一封', tag: '经典' },
      { name: '穷查理宝典', author: '查理·芒格', desc: '多元思维模型，芒格的智慧', tag: '经典' },
      { name: '投资中最简单的事', author: '邱国鹭', desc: 'A股价值投资的实操，便宜才是硬道理', tag: 'A股' },
      { name: '价值', author: '张磊', desc: '高瓴资本，长期主义理念', tag: 'A股' },
      { name: '投资最重要的事', author: '霍华德·马克斯', desc: '讲透风险与周期，第二层思维', tag: '经典' },
    ],
  },
  {
    title: '短线 · 打板 / 龙头',
    ...
    items: [
      { name: '一进二战法', desc: '首板涨停只是偶然，二板才是资金共识的验证。博弈次日晋级', tag: '打板' },
      { name: '龙头战法', desc: '情绪周期四阶段（试错→主升→高位→主跌），只做最强龙头', tag: '龙头' },
      { name: '陈小群模式', desc: '三板定龙头、五板看格局；首阴反包强，二波更有戏', tag: '龙头' },
      { name: '核心心法', desc: '买在分歧卖在一致、会空仓才是祖师爷、只买核心股不买杂毛股', tag: '心法' },
      { name: '风控纪律', desc: '单笔止损 3%-5%，分仓 2-3 只，退潮期强制空仓', tag: '风控' },
    ],
  },
];
